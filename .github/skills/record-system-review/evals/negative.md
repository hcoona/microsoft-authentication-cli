...
- adds `docs/status.md` with a second copy of the current stage and active Issue;
...
1. A blocking GOV-002 finding: `docs/status.md` duplicates the authority of
   `docs/project-state.md`; remove it or make it a non-normative link.
